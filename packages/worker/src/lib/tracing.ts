...
export function initTracing(): void {
  ...
  const serviceName = process.env['OTEL_SERVICE_NAME'] ?? 'mail-queue-worker';
  ...
  sdk = new NodeSDK({
    ...
    instrumentations: [
      getNodeAutoInstrumentations({
        ...
        // Configure Redis instrumentation for BullMQ
        ...
        // Configure Net instrumentation for SMTP connections
